...
/* Theme toggle — the universal light/dark glyphs. Hull (light) is the
   sun, Void (dark) the moon; the old disc/ring pair below is kept for the
   tokens doc and anything else that still imports it. */
