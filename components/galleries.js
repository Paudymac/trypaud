...
const Galleries = () => {
    ...
    return (
        ...
        <h1>Galleries</h1>
          ...
          <a ref={ref1} className={`${utilStyles.mainMenu} ${isVisible1 ? utilStyles.visible : ''}`} href="/ui-web">
           <Image
                        priority
                      ...
                      />
          UI / Web</a>
          <a ref={ref2} className={`${utilStyles.mainMenu} ${isVisible2 ? utilStyles.visible : ''}`} href="/logos">
          <Image
                        priority
          ...
          <a ref={ref3} className={`${utilStyles.mainMenu} ${isVisible3 ? utilStyles.visible : ''}`} href="/branding">
          <Image
                        priority
                      ...
                      />
          Branding</a>
          <a ref={ref4} className={`${utilStyles.mainMenu} ${isVisible4 ? utilStyles.visible : ''}`} href="/icons">
          <Image
                        priority
                      ...
                      />
          Icons</a>
          <a ref={ref5} className={`${utilStyles.mainMenu} ${isVisible5 ? utilStyles.visible : ''}`} href="/animation">
          <Image
                        priority
                      ...
                      />
          Animation</a>
          <a ref={ref6} className={`${utilStyles.mainMenu} ${isVisible6 ? utilStyles.visible : ''}`} href="/illustration">
          <Image
                        priority
