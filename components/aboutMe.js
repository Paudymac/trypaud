...
const AboutMe = () => {
    ...
    return (
      ...
      <div ref={ref1} className= {`${utilStyles.aboutMeImgContainer} ${isVisible1 ? utilStyles.visible : ''}`}>
      <div className={utilStyles.aboutMeImg}></div>
      </div>

        <div ref={ref2} className={`${utilStyles.aboutMeDescipt} ${isVisible2 ? utilStyles.visible : ''}`}>
