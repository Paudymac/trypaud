      ...
      <section>
        ...
        <article id="case-study">
          <div className={styles.caseStudyContainer}>
            ...
            <p>
              The task was to create a scalable logo with different marks, a
              brand guide and a site to drive traffic to every players’ chosen
              platform when the game and DLC were released.{' '}
            </p>
          </div>
          ...
          <div className={styles.caseStudyContainer}>
            <p>
              ...
              integrated marketing campaign was created by Californian
              advertising power house Petrol. Their partnership allowed the
              marketing team at Piranha to reach our audience in new and
              innovative ways.
            </p>
          </div>
          ...
          <div className={styles.caseStudyContainer}>
            <p>
              The homepage design wanted to utilise the behemoth Atlas Mech
              acting as the totem Mech for the game. I added subtle animation to
              bring it to life with the latest communications about the game
              below.
            </p>
          </div>
          ...
          <div className={styles.caseStudyContainer}>
            <p>
              The goal was to keep things simple. The site had look good on
              mobile just as much as desktop. Traffic was being driven from
              visuals on social media which were added to DLC page designs.
              Interactive game content including video, in game screenshots and
              basic story narratives were added so players had a good
              understanding of content in each DLC Pack.
            </p>
          </div>
