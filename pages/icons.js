    ...
    <Layout home>
     <Head>
      ...
      <section className={utilStyles.headingMd}>
        ...
        <Image className={utilStyles.contentImg} src="/images/icons/mw5-clans-icon.jpg" width={960} height={540} alt="cow skull"/><br/>
        ...
        <p className={utilStyles.descriptionPortfolio}>PGI [ Design / Development ]</p>
